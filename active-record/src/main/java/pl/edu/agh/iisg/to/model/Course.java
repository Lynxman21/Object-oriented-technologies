...
public class Course {
    ...
    public List<Student> studentList() {
        String findStudentListSql = "SELECT s.id, s.first_name, s.last_name, s.index_number" +
                " FROM student s " +
        ...
        try {
            ...
            while (rs.next()) {
                Student s = new Student(rs.getInt("id"),rs.getString("first_name"),rs.getString("last_name"),rs.getInt("index_number"));
                resultList.add(s);
            }
        } catch (SQLException e) {
