...
public class SchoolDemo {
    ...
    public SchoolDemo() {
//        SerializablePersistenceManager spm = new SerializablePersistenceManager();
//        spm.setClassStorageFileName("classesSet.dat");
//        spm.setTeachersStorageFileName("teachersSet.dat");
        Injector injector = Guice.createInjector(new SchooleModule());
