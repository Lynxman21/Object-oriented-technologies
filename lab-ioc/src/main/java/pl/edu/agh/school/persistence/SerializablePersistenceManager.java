...
//    private static final Logger log = Logger.getInstance();
    ...
    @Inject
    public void setTeachersStorageFileName(@Named("teacherPath") String teachersStorageFileName) {
        this.teachersStorageFileName = teachersStorageFileName;
    }

    @Inject
    public void setClassStorageFileName(@Named("classPath") String classStorageFileName) {
